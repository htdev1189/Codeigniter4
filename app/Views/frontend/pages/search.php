...
<div class="row">
    ...
    <div class="col-12">
        <div class="breadcrumbs mb-4">
            <a href="<?= route_to('blog.home') ?>">Home</a><span class="mx-1">/</span>
            <a href="<?= route_to('blog.home') ?>">Search</a><span class="mx-1">/</span>
    ...
    <div class="col-lg-8 mb-5 mb-lg-0">
        <?php if (count($posts) > 0) : ?>
            ...
            <!-- pagination -->
            <?php if ($pager && $pager->getPageCount('search') > 1): ?>
                <?= $pager->links('search', 'default_cat') ?>
            <?php endif; ?>
        <?php endif; ?>
    </div>
