            ...
            <div class="dropdown">
                <a
                    ...
                    <span class="user-icon">
                        <img src="<?= get_user()->picture == null ? '/images/users/default.jpg' : '/images/users/' . get_user()->picture ?>" alt="" />
                    </span>
                ...
                <div
                    ...
                    <a class="dropdown-item" href="<?= route_to('admin.setting') ?>"><i class="dw dw-settings2"></i> Setting</a>
